        ...
        <div class="row">
            ...
            <form method='POST' action='/argument/update/{{$argument->id}}'>
                ...
                <div class='form-group'>
                    ...
                    <input type='text' class='form-control' name='assumption' id='assumption'
                           value='{{ old('assumption', $argument->assumption) }}'>
                ...
                <div class='form-group'>
                    ...
                    <input type='text' class='form-control' name='conclusion' id='conclusion'
                           ...
                           value='{{ old('conclusion', $argument->conclusion) }}'>
                ...
                <div class='form-group'> Philosopher Pulldown
                    <select class='form-control' name='philosopher' id='philosopher'>
                        ...
                        @foreach ($philosophers as $philosopher)
                            <option value="{{$philosopher->id}}" {{($philosopher->id == $argument->philosopher_id) ? 'selected' : ''}}>{{$philosopher->name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class='form-group'> Works Pulldown
                    <select class='form-control' name='work' id='work'>
                        ...
                        @foreach ($works as $work)
                            <option value="{{$work->id}}" {{($work->id == $argument->work_id) ? 'selected' : ''}}>{{$work->title}}</option>
                        @endforeach
                    </select>
                </div>
